...
A token is used for authentification and identification. 

- [ ] What steps can you take in your web apps to keep your data secure?

The use of tokens and private routes. 

- [ ] Describe how web servers work.

Web servers process incoming information using HTTP and stores, prcocesses and delivers webpages to clients. 
